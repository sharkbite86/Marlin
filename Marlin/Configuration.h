...
// Mechanical endstop with COM to ground and NC to Signal uses "false" here (most common setup).
  ...
  #define X_MIN_ENDSTOP_HIT_STATE LOW // set to true to invert the logic of the endstop.
#else
  #define X_MIN_ENDSTOP_HIT_STATE HIGH // set to true to invert the logic of the endstop.
#endif
#define X_MAX_ENDSTOP_HIT_STATE X_MIN_ENDSTOP_HIT_STATE
#if ANY(MachineCR2020, MachineCR30, MachineCR5, MachineEnder3S1)
  #define Y_MIN_ENDSTOP_HIT_STATE LOW // set to true to invert the logic of the endstop.
#else
  #define Y_MIN_ENDSTOP_HIT_STATE HIGH // set to true to invert the logic of the endstop.
#endif
#define Y_MAX_ENDSTOP_HIT_STATE Y_MIN_ENDSTOP_HIT_STATE
 ...
 */
  ...
  #define NOZZLE_CLEAN_STROKES     5   // Default number of pattern repetitions
